...
class UserProfile(BaseModel):
    ...
    # TABLE UNIQUE INDEX: user_id_1836_uiq(user_id)
    # --------------------Danio Hints--------------------
...
class Pet(BaseModel):
    ...
    # TABLE INDEX: user_id_8759_idx(user_id)
    # --------------------Danio Hints--------------------
    user_id: typing.Annotated[int, danio.IntField] = 0
...
class UserGroup(BaseModel):
    ...
    # TABLE UNIQUE INDEX: group_id_user_i_8760_uiq(group_id,user_id)
    # --------------------Danio Hints--------------------
...
class User(BaseModel):
    ...
    # TABLE INDEX: created_at_6065_idx(created_at)
    # TABLE INDEX: updated_at_7069_idx(updated_at)
    # --------------------Danio Hints--------------------
